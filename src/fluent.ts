...
import { isFluentRasterStyle, resolveFluentSource } from "./fluentMeta.ts";
import type { FluentEmojiSource } from "./types.ts";
...
export type { ResolvedFluentSource } from "./fluentMeta.ts";
...
export function isFluent3dSource(source: "fluent" | FluentEmojiSource): boolean {
  return isFluentRasterStyle(resolveFluentSource(source).style);
}
